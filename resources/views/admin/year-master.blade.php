                        ...
                        <div class="breadcome-list">
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-end">
                                    ...
                                    <a class="btn btn-primary ms-3 add-year-master">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body table-responsive p-0">
                                <table id="year-table-id" class="year-table">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Name</th>
            ...
            <div class="modal-dialog modal-dialog-centered modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <h2 class="modal-title" id="companytabs">Add Year Master</h2>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div>
                    <div class="modal-body">
                        <form class="row" method="post" id="yearform" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" name="year_id" id="yearid" value="">
                            <div class="col-lg-12">
...
@section('scripts')
    <script>
        $('.edit-form').hide();
        // add user form show
        $(document).on('click', '.add-year-master', function() {
            $('.modal-title').text('Add Yaer Master');
            $('#yearid').val('');
            $("#yearform")[0].reset();
            $('span[id$="_error"]').text('');
            $('.edit-form').hide();
            ...
            $.ajax({
                ...
                success: (data) => {
                    if (data.status == 200) {
                        ...
                        if ($('#yearid').val() == '') {
                            toastr.success("Year Master addedd successfully.");
                        } else {
                            toastr.success("Year Master updated successfully.");
                        }
                        dataTable.draw();
                    } else {
        ...
        function editYearMaster(id) {
            ...
            $.ajax({
                ...
                dataType: "json",
                success: (data) => {
                    $('.modal-title').text('Edit Year Master');
                    $("#yearform")[0].reset();
                    $('.edit-form').show();
                    // set edit value
