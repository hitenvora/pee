...
@section('content')
    <div class="all-content-wrapper">
        <div class="header-advance-area">
                                ...
                                <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <div class="breadcome-heading">
                                            <h3>Purchase Empty Bottle Master</h3>
                                        </div>
                                    </div>
            ...
            <div class="modal fade product-modal" id="purchasetab" tabindex="-1" aria-labelledby="purchasetabs"
                aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h2 class="modal-title" id="purchasetabs">Add Purchase Empty Bottle</h2>
                        ...
                        <div class="modal-body">
                            <form class="row" method="post">
                                ...
                                <div class="col-lg-4">
                                    <label class="form-label">No. Of Bottle</label>
                                    <input type="text" class="form-control" id="disc_date" name="disc_date"
                                ...
                                <div class="col-lg-4">
                                    <label class="form-label">Total Payable Account</label>
                                    <input type="text" class="form-control" id="disc_date" name="disc_date"
                                        value="60000">
                                </div>
                                <div class="col-lg-12">
            ...
            <div class="modal fade" id="editmodal" tabindex="-1" aria-labelledby="editmodal" aria-hidden="true">
                <div class="modal-dialog modal-dialog-centered modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h2 class="modal-title" id="editmodal">Edit Purchase Empty Bottle</h2>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
